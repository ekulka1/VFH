...
if __name__ == '__main__':
    ...
    depth = cv2.imread("./pictures/cube3.jpg", 0)
    color = cv2.imread("./pictures/cube3.jpg", 1)  # Assuming color image, change to 0 if grayscale
    ...
    rgbd_reproj = pcd.project_to_rgbd_image(1000,
                                            1000,
                                            intrinsic,
                                            depth_scale=7000.0,
                                            depth_max=10.0)
    ...
    np.save("./DepthImages/depth_values_cube3.npy", np.asarray(rgbd_reproj.depth.to_legacy()))
    ...
    cv2.imwrite("./DepthImages/Grayscaled_Image_cube3.png", np.asarray(rgbd_reproj.depth.to_legacy()))
        # Save the depth image
    cv2.imwrite("./DepthImages/Depth_Image.png_cube3.png", img)
